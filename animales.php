<?php
	...
	-- Descripción larga --
		...
		El controlador hace un require de view/vista_animales.php y vista hace un echo.
	-- Argumentos --
	...
	**/
	...
	$arTableAnimals = mod004_getAnimalPagination( $pag, $numRegistros );
	$layerSelect = mod004_getSelectRaces();
	if ( $arTableAnimals[ 0 ] !== "002" ) {
		require ( "view/vista_animales.php" );
	} else {
